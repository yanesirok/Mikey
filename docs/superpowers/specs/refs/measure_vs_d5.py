...
ARENA_ZONES = {
    ...
    'бамбук L':  (0.02, 0.05, 0.14, 0.45),
    'бамбук R':  (0.87, 0.05, 0.99, 0.45),
    # Вся полоса досок, а не её край. Край читает 69, центр 88, полоса целиком 94.1 — и это
    # ровно то число, которое меряют спеки проекта (07-30: «настил ушёл со 101.9 на 94.3»).
    # Первый прогон брал x 0.06..0.22 и потому объявил настил на 22 единицы темнее эталона,
    # хотя он совпадает с ним в пределах трёх.
    'настил':    (0.02, 0.80, 0.98, 0.90),
