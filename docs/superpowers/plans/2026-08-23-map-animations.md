...
>
> Взаимодействие с дыханием: пока вход не завершён, масштаб маркера задаёт
> каскад; после завершения — дыхание. Обе величины пишутся одним и тем же
> инлайновым присваиванием в тике, поэтому гонки между ними нет по построению.
