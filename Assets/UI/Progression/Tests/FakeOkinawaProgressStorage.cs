...
{
    /// <summary>In-memory <see cref="IOkinawaProgressStorage"/> so store tests never touch real local storage.</summary>
    public sealed class FakeOkinawaProgressStorage : IOkinawaProgressStorage
    {
